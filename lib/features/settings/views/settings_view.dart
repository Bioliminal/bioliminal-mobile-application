...
class SettingsView extends ConsumerWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _item(Icons.info_outline, 'AuraLink Version', '1.0.0-premium', theme),
            _item(
            ...
            Center(
              child: TextButton(
                ...
                child: const Text('RE-WATCH ONBOARDING', style: TextStyle(color: Colors.white30)),
              ),
            ),
  ...
  Widget _item(IconData icon, String title, String value, ThemeData theme,
      {VoidCallback? onTap}) {
